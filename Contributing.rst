...
* Developer Installation(:ref:`install-the-transistordatabase-as-a-pip-package-in-developer-mode`)
* Write Code(:ref:`write-code`)
* Write Tests(:ref:`write-pytest`)
* Generate pip Package(:ref:`release-workflow`)
