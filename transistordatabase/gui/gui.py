...
class MainWindow(QMainWindow):
    ...
    def export_datasheet(self):
        ...
        self.show_popup_message(
            f"Exported a virtual datasheet for <b>{transistor.name}</b> to <a href={pathlib.Path.cwd().as_uri()}>{pathlib.Path.cwd().as_uri()}</a>")
    ...
    def export_gecko(self):
        ...
        try:
            ...
            self.show_popup_message(
                f"Exported GeckoCircuits files for {transistor_parallel.name} to <a href={pathlib.Path.cwd().as_uri()}>{pathlib.Path.cwd().as_uri()}</a>")
        except:
            self.show_popup_message("Error: One or more invalid inputs!")
